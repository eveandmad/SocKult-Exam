...
#Write .csv
write.csv(simonsen_19, file = "Simonsen_clean.csv")
...
#Write .csv
write.csv(cogsci_18, file = "cogsci_clean.csv")
...
study.draws <- spread_draws(meta_model_post, r_Article[Article,], b_Feedback) %>% 
...
#Exclude empty rows in bottom of p_1
p1 <- p1[1:38,]
...
#Write .csv
write.csv(sc_df_clean, file = "sc_clean.csv")
